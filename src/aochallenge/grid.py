...
def is_within_3d(coord: _Coord3D, corner1: _Coord3D, corner2: _Coord3D) -> bool:
    ...
    c1 = _c3d(corner1)
    c2 = _c3d(corner2)
    return v.x >= c1.x and v.y >= c1.y and v.z >= c1.z and v.x <= c2.x and v.y <= c2.y and v.z <= c2.z
...
def bounded_neighbours_2d(coord: _Coord2D, corner1: _Coord2D, corner2: _Coord2D) -> list[Coord2D]:
    return [d + coord for d in _neighbour_direct_2d if is_within_2d(d+coord, corner1, corner2)]
...
def bounded_neighbours_full_2d(coord: _Coord2D, corner1: _Coord2D, corner2: _Coord2D) -> list[Coord2D]:
    return [d + coord for d in _neighbour_corner_2d if is_within_2d(d+coord, corner1, corner2)]
...
def bounded_neighbours_3d(coord: _Coord3D, corner1: _Coord3D, corner2: _Coord3D) -> list[Coord3D]:
    return [d + coord for d in _neighbour_direct_3d if is_within_3d(d+coord, corner1, corner2)]
...
def bounded_neighbours_edge_3d(coord: _Coord3D, corner1: _Coord3D, corner2: _Coord3D) -> list[Coord3D]:
    return [d + coord for d in _neighbour_edge_3d if is_within_3d(d+coord, corner1, corner2)]
...
def bounded_neighbours_full_3d(coord: _Coord3D, corner1: _Coord3D, corner2: _Coord3D) -> list[Coord3D]:
    return [d + coord for d in _neighbour_corner_3d if is_within_3d(d+coord, corner1, corner2)]
